...
def acolite_run_test_v2(settings, inputfile=None, output=None, limit=None, verbosity=0):
            ...
            if l1r_setu['atmospheric_correction']:
                ...
                if (l2r_setu['adjacency_correction']):
                    ...
                    if (l2r_setu['adjacency_method'] == 'ajfilter'):
                        ...
                        _filter = ac.adjacency.ajfilter.ajfilter_v2(l2r=l2r,settings=l2r_setu)
                        ret = _filter.run(acmode=ac_mode_cur, aot550=aot_550_cur,senz=vza,max_iter=ajfilter_iter)
